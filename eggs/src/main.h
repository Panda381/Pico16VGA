...
// game screen start position
#define X0	64	// game screen start X position	
#define Y0	48	// game screen start Y position
...
// score
#define SCOREX	(58+FRAMEX) // score X offset
#define SCOREY	104	// score Y offset
#define WINX	(58+FRAMEX) // win X offset
#define WINY	152	// win Y offset
#define SCORECOL COL_WHITE // score color
#define SCOREBG COL_LTBLUE // score background
...
// image pitch: 8 bytes
extern const u8 ComputerImg[128] __attribute__ ((aligned(4)));

// format: 4-bit pixel graphics
// image width: 128 pixels
// image height: 384 lines
// image pitch: 64 bytes
extern const u8 FrameImg[24576] __attribute__ ((aligned(4)));

// format: 4-bit pixel graphics
// image width: 512 pixels
// image height: 384 lines
// image pitch: 256 bytes
extern const u8 OpenImg[98304] __attribute__ ((aligned(4)));

// format: 4-bit pixel graphics
// image width: 128 pixels
// image height: 80 lines
// image pitch: 64 bytes
extern const u8 SelectImg[5120] __attribute__ ((aligned(4)));

// format: 4-bit pixel graphics
// image width: 32 pixels
// image height: 736 lines
// image pitch: 16 bytes
extern const u8 TilesImg[11776] __attribute__ ((aligned(4)));
