...
extern const u8 GradientRGBImg[12800] __attribute__ ((aligned(4)));
#elif COLOR_FORMAT == COLOR_FORMAT_BGR // color format BGR: bit2 blue, bit1 green, bit0 red
extern const u8 GradientBGRImg[12800] __attribute__ ((aligned(4)));
#else // COLOR_FORMAT == COLOR_FORMAT_GRB, color format GRB: bit2 green, bit1 red, bit0 blue
extern const u8 GradientGRBImg[12800] __attribute__ ((aligned(4)));
#endif // COLOR_FORMAT
