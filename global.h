...
// VGA includes
#include "_vga/mat2d.h"		// 2D transformation matrix
#include "_vga/draw.h"		// draw
#include "_vga/rand.h"		// random number generator
#include "_vga/pwmled.h"	// PWM LED output
#include "_vga/pwmsnd.h"	// PWM sound output
#include "_vga/vga.h"		// VGA core
